package com.zjkj.yuerbao.common.util.qq.util;
...
public class Util {
	...
	public static JSONObject getHtmlJSONObject(final String url) {
		URL htmlUrl = null;
		InputStream inStream = null;
		try {
			htmlUrl = new URL(url);
		...
		try {
			jsonObj = new JSONObject(inputStreamToString(inStream));
	...
	public static String inputStreamToString(InputStream is) {
		try {
			...
			String jsonStr = bytestream.toString();
			bytestream.close();
			return jsonStr;
		} catch (Exception e) {
			e.printStackTrace();
